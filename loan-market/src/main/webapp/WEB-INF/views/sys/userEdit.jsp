        ...
        <form id="userEditForm" method="post">
            ...
            <table class="grid">
                <tr>
                    ...
                    <td><input name="id" type="hidden" value="${user.id}">
                        <input name="loginName" type="text" placeholder="请输入登录名称" class="easyui-validatebox"
                               data-options="required:true" value="${user.loginName}"></td>
                    <td>姓名</td>
                ...
                <tr>
                    ...
                    <td>性别</td>
                    <td><select id="userEditSex" name="sex" class="easyui-combobox"
                ...
                <tr>
                    ...
                    <td>用户类型</td>
                    <td><select id="userEditUserType" name="userType" class="easyui-combobox"
                                data-options="width:140,height:29,editable:false,panelHeight:'auto'">
                ...
                <tr>
                    <td>部门</td>
                    <td><select id="userEditorganizationId" name="organizationId" style="width: 140px; height: 29px;"
                ...
                <tr>
                    ...
                    <td>用户类型</td>
                    <td><select id="userEditStatus" name="status" value="${user.status}" class="easyui-combobox"
                                data-options="width:140,height:29,editable:false,panelHeight:'auto'">
                ...
                <tr>
                    <td>权重</td>
                    <td>
                        <input type="text" name="weight" class="easyui-numberbox" value="${user.weight}"/>
                    </td>
                </tr>
            </table>
        </form>
